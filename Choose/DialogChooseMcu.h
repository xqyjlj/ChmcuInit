...
#ifndef CHMCUINIT_DIALOGCHOOSEMCU_H
#define CHMCUINIT_DIALOGCHOOSEMCU_H
...
public:
    ...
    ~DialogChooseMcu() override;

signals:
    void signalCreateMcuProject();

private slots:
    void slotButtonBoxClick(QAbstractButton* button);

    void slotTableWidgetMcuSelectionMcuNameChanged(const QString& mcuName);
private:
    Ui::DialogChooseMcu *ui;
...
#endif //CHMCUINIT_DIALOGCHOOSEMCU_H
