...
#include <QPointF>
mcu_scene::mcu_scene(QObject* parent): QGraphicsScene(parent)
{

}

void mcu_scene::mousePressEvent(QGraphicsSceneMouseEvent* event)
{
...
void mcu_scene::mouseMoveEvent(QGraphicsSceneMouseEvent* event)
{
...
void mcu_scene::mouseReleaseEvent(QGraphicsSceneMouseEvent* event)
{
