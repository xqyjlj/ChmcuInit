...
#ifndef CHMCUINIT_FORMHOME_H
#define CHMCUINIT_FORMHOME_H
...
private slots:
    void slotButtonCreateChipProjectPressed();

    void slotButtonCreateBoardProjectPressed();
private:
    Ui::FormHome *ui;
